      ...
      <div className={`${styles["header-top"]} border-lg-bottom`}>
        <div className="container-mid px-0 px-lg-3">
          <div className="d-flex justify-content-between align-items-center py-md-3 py-2 w-100">
            ...
            <div className="d-none d-lg-block flex-grow-1 px-4">
              <HeaderSearch />
            </div>
            <nav className="main-navigation d-none d-lg-flex align-items-center justify-content-center">
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-4">
                          ...
                          <ul className="megamenu-list">
                            <li>
                              <Link href="/search?condition=Used&maxPrice=5000">
                                Used Cars Under $5,000
                              </Link>
                            </li>
                            <li>
                              <Link href="/search?condition=Used&maxPrice=10000">
                                Used Cars Under $10,000
                              </Link>
                            </li>
                            <li>
                              <Link href="/search?condition=Used&maxPrice=15000">
                                Used Cars Under $15,000
                              </Link>
                            </li>
                            <li>
                              <Link href="/search?condition=Used&maxPrice=20000">
                        ...
                        <div className="col-lg-4">
                          ...
                          <ul className="megamenu-list">
                            <li>
                              <Link href="/search?condition=Used&q=SUV">
                                Used SUVs for Sale
                              </Link>
                            </li>
                            <li>
                              <Link href="/search?condition=Used&q=Ute">
                                Used Utes for Sale
                              </Link>
                            </li>
                            <li>
                              <Link href="/search?condition=Used&q=Hatchback">
                                Used Hatchbacks
                              </Link>
                            </li>
                            <li>
                              <Link href="/search?condition=Used&q=Sedan">
                                Used Sedans
                              </Link>
                            </li>
                            <li>
                              <Link href="/search?condition=Used&q=Wagon">
                                Used Wagons
                              </Link>
                            </li>
                            <li>
                              <Link href="/search?condition=Used&q=4WD">
                                Used 4WDs
                              </Link>
                            </li>
                            <li>
                              <Link href="/search?condition=Used&q=Van">
                                Used Vans
                              </Link>
                            </li>
                          </ul>
                        ...
                        <div className="col-lg-4">
                          ...
                          <ul className="megamenu-list">
                            <li>
                              <Link href="/search?fuelType=Petrol+-+Unleaded">
                                Petrol - Unleaded
                              </Link>
                            </li>
                            <li>
                              <Link href="/search?fuelType=Petrol+-+Premium+ULP">
                                Petrol - Premium ULP
                              </Link>
                            </li>
                            <li>
                              <Link href="/search?fuelType=Diesel">
                                Used Diesel Cars
                              </Link>
                            </li>
                            <li>
                              <Link href="/search?fuelType=Petrol">
                                Used Petrol Cars
                              </Link>
                            </li>
                          </ul>
            ...
            {/* Right Side Actions */}
            <div
              className={`${styles["header-actions"]} d-flex align-items-center gap-3`}
            >
              {/* Search Icon Trigger */}
              {/* <a
                href="#"
                className={`${styles["search-trigger"]} d-none d-lg-flex`}
                aria-label="Search"
              >
                <svg
                  width="24"
              ...
              <Link
                href="/shortlist"
                className={`${styles["shortlist-icon"]} d-none d-lg-flex`}
